		...
		<div class="site-info">
			<div class="site-info-inner main-width flex">
				<div class="site-info-inner-left">
					...
					<?php } ?>
					<span class="generator"><?php echo esc_html__( 'Powered by ', 'photoblogger' ); ?><a href="<?php echo esc_url( 'http://wordpress.org/' ); ?>" rel="generator">WordPress</a></span>
					<span class="sep"> | </span>
					<span class="designer"><?php printf( esc_html__( 'Theme: %1$s by %2$s.', 'photoblogger' ), '<a href="http://michaelvandenberg.com/portfolio/photoblogger/" rel="theme">PhotoBlogger</a>', 'Michael Van Den Berg' ); ?></span>
